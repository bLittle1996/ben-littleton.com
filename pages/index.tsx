      ...
      <main className="max-w-3xl mx-auto px-8">
        <article id="about">
          ...
          <p>
            ...
            difference in people's lives, no matter how small. I strive to learn
            at least one new thing everyday so that I can be better equipped to
            make that difference. If you want to take a look at what
