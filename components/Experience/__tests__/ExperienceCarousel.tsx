...
describe(ExperienceCarousel, () => {
  ...
  it("can render multiple <Experience />", async () => {
    const twCss = await generateTailwindCSS();
    ...
    const injectedStyle = injectCSSIntoContainer(container, twCss);
    ...
    container.removeChild(injectedStyle);
  });
});
